...
!function(a){a(function(){if("object"==typeof MediaUpload)for(var b=0;b<MediaUpload.instances.length;b++){var c=MediaUpload.instances[b],d=c.settings;a("#jquery-wrapped-fine-uploader-"+c.id).fineUploader({multiple:!0,debug:!0,template:"simple-previews-template",classes:{success:"alert alert-success",fail:"alert alert-error"},validation:{allowedExtensions:d.allowedExtensions,itemLimit:d.maximumItems,sizeLimit:d.maximumSize},messages:d.messages,showMessage:function(a){alert(a)},deleteFile:{enabled:!0,method:"POST",endpoint:"/index.php",params:{type:1386871774}},request:{endpoint:"/index.php"}}).on("deleteComplete",function(){var b=[];a("#qq-upload-list-"+d.uniqueId).find("li.alert-success").find(".view-btn").each(function(c,d){var e=a(d).attr("href"),f=e.replace(/.*\//,"");b.push(f)}),a("#uploaded-files-"+d.property).val(b.join(","))}).on("submit",function(){var b={},c="tx_mediaupload_pi1";b[c+"[storageIdentifier]"]=d.storage,b.type="1386871773",a(this).fineUploader("setParams",b)}).on("complete",function(b,c,e,f){var g=d.uniqueId,h=d.property,i=a(this).fineUploader("getItemByFileId",c),j=i.find(".view-btn");if(f.success){j.removeClass("hide"),j.attr("href",f.viewUrl);var k=[];a("#qq-upload-list-"+g).find("li.alert-success").find(".view-btn").each(function(b,c){var d=a(c).attr("href"),e=d.replace(/.*\//,"");k.push(e)}),a("#uploaded-files-"+h).val(k.join(","))}})}})}(jQuery);
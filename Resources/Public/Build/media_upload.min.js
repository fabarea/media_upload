...
!function(a){a(function(){var b=function(){var a=window.location.pathname;return/index.php/.test(window.location.pathname)&&(a+=window.location.search),a};if("object"==typeof MediaUpload)for(var c=0;c<MediaUpload.instances.length;c++){var d=MediaUpload.instances[c],e=d.settings;a("#jquery-wrapped-fine-uploader-"+d.id).fineUploader({multiple:!0,debug:!0,template:"media-upload-template",classes:{success:"alert alert-success",fail:"alert alert-error"},validation:{allowedExtensions:e.allowedExtensions,itemLimit:e.maximumItems,sizeLimit:e.maximumSize},messages:e.messages,showMessage:function(a){alert(a)},deleteFile:{enabled:!0,method:"POST",endpoint:b(),params:{type:1386871774}},request:{endpoint:b()}}).on("deleteComplete",function(){var b=[];a("#qq-upload-list-"+e.uniqueId).find("li.alert-success").find(".view-btn").each(function(c,d){var e=a(d).attr("href"),f=e.replace(/.*\//,"");b.push(f)}),a("#uploaded-files-"+e.property).val(b.join(","))}).on("submit",function(){var b={},c="tx_mediaupload_pi1";b[c+"[storageIdentifier]"]=e.storage,b.type="1386871773",a(this).fineUploader("setParams",b)}).on("complete",function(b,c,d,f){var g=e.uniqueId,h=e.property,i=a(this).fineUploader("getItemByFileId",c),j=i.find(".view-btn");if(f.success){j.removeClass("hide"),j.attr("href",f.viewUrl);var k=[];a("#qq-upload-list-"+g).find("li.alert-success").find(".view-btn").each(function(b,c){var d=a(c).attr("href"),e=d.replace("/typo3temp/pics/","");k.push(e)}),a("#uploaded-files-"+h).val(k.join(","))}})}})}(jQuery);